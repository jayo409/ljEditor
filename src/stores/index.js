...
class EditStore {
	...
	@observable clickMenuState = {};

	// 更改面板显示
	@action.bound changeVisible = (param, close) => {
		this.panelVisible[param] = close === 1 ? false : !this.panelVisible[param]
	}
	...
	@action.bound insertTable = (o) => {
		Sel.getEditRange();
		document.execCommand('insertHTML', false, tableTemp(o.row, o.col));
		this.panelVisible.table = !this.panelVisible.table
		Sel.setEditRange()
	}
	...
	@action.bound updateClickMenuState = (obj) => {
		this.clickMenuState = obj;
	}
